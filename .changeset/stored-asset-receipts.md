...
cross-Workspace receipt fails the whole status update. New queries read a bounded, newest-first window of an
album's visible receipts or one exact version, and a deletion ledger hides assets before Storage deletion, keeps
